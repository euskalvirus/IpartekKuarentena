			...
			<c:forEach items="${servicios}" var="servicio">
				<tr>
					...
					<td>
						...
						href="admin/servicios?id=${servicio.id}&op=modificar">Modificar</a> 
						<a class="btn btn-danger my-1" data-id="${servicio.id}" data-name="${servicio.nombre}" 
						data-href="admin/servicios" data-op="borrar"  data-toggle="modal" data-target="#modal">Borrar</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
