			...
			<c:forEach items="${trabajadores}" var="trabajador">
				<tr>
					...
					<td>
						...
						href="admin/trabajadores?id=${trabajador.id}&op=modificar">Modificar</a> 
						<a class="btn btn-danger my-1" data-id="${trabajador.id}" data-name="${trabajador.nombre}" 
						data-href="admin/trabajadores" data-op="borrar" data-toggle="modal" data-target="#modal">Borrar</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	<div class="col-12 table-sm">
		<a class="btn btn-primary" href="admin/trabajadores?op=agregar">Añadir</a>
